...
llm_tokens_generated = Counter('llm_tokens_generated_total', 'Total tokens generated by the LLM')
llm_response_duration = Histogram('llm_response_duration_seconds', 'Time spent generating LLM responses')